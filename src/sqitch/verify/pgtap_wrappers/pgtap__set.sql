-- Verify dream-db-extension:pgtap_wrappers/pgtap__set on pg
...
declare _expected_function_name name := 'pgtap__set';
declare _expected_function_signatures text[] := array['text, int4', 'text, int4, text'];
