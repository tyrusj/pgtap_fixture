-- Verify dream-db-extension:create-function-to-plan-child-tests-and-fixtures on pg
...
declare _expected_function_name name := '_plan_child_tests_and_fixtures';
declare _expected_function_arg_types text := 'int4';
