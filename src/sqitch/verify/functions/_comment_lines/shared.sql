-- Verify dream-db-extension:functions/_comment_line/create on pg
...
declare _expected_function_name name := '_comment_lines';
declare _expected_function_arg_types text := 'text, int4';
