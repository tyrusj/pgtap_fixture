-- Verify dream-db-extension:functions/_format_result/create on pg
...
declare _expected_function_name name := '_format_result';
declare _expected_function_arg_types text := 'bool, int4, text, text';
