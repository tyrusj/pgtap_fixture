-- Verify dream-db-extension:functions/_format_subtest/create on pg
...
declare _expected_function_name name := '_format_subtest';
declare _expected_function_arg_types text := 'text, text';
