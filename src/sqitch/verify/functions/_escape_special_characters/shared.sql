-- Verify dream-db-extension:functions/_escape_special_characters/create on pg
...
declare _expected_function_name name := '_escape_special_characters';
declare _expected_function_arg_types text := 'text';
