-- Verify dream-db-extension:functions/_get_fixture_by_path_and_root/create on pg
...
declare _expected_function_name name := '_get_fixture_by_path_and_root';
declare _expected_function_arg_types text := 'text, int4, bool';
