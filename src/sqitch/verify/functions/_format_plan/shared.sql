-- Verify dream-db-extension:functions/_format_plan/create on pg
...
declare _expected_function_name name := '_format_plan';
declare _expected_function_arg_types text := 'int4, text';
