-- Verify dream-db-extension:create-function-to-execute-tests-with-data on pg
...
declare _expected_function_name name := '_execute_test';
declare _expected_function_arg_types text := 'int4, int4';
