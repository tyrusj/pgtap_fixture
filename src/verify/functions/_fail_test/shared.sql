-- Verify dream-db-extension:functions/_fail_test on pg
...
declare _expected_function_name name := '_fail_test';
declare _expected_function_signatures text[] := array['int4, int4, text'];
