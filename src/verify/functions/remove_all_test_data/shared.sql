-- Verify dream-db-extension:functions/remove_all_test_data/create on pg
...
declare _expected_function_name name := 'remove_all_test_data';
declare _expected_function_arg_types text := 'name, name';
