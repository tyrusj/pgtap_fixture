-- Verify dream-db-extension:functions/execute_tests/create on pg
...
declare _expected_function_name name := 'execute_tests';
declare _expected_function_arg_types text := '_text, name, _text';
