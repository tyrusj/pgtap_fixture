-- Verify dream-db-extension:functions/_format_skip/create on pg
...
declare _expected_function_name name := '_format_skip';
declare _expected_function_arg_types text := 'bool, int4, text, text, text';
