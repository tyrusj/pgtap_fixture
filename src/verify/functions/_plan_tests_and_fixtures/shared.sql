-- Verify dream-db-extension:create-function-to-plan-tests-and-fixtures on pg
...
declare _expected_function_name name := '_plan_tests_and_fixtures';
declare _expected_function_arg_types text := '_int4, _int4';
