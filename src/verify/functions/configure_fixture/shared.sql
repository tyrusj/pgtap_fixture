-- Verify dream-db-extension:functions/configure_fixture/create on pg
...
declare _expected_function_name name := 'configure_fixture';
declare _expected_function_arg_types text := 'text, text, text, text, text, text';
