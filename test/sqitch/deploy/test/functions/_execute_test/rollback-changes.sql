-- Deploy dream-db-extension-tests:functions/_execute_test/rollback-changes to pg

BEGIN;

create function unit_test.test_func_execute_test__rollback_changes()
returns setof text
language plpgsql
as
$$
...
test, the function shall rollback changes made by the fixture setup, the test, and the fixture teardown.
$test_description$;
...
begin
    ...
    values (
        ...
        $teardown$insert into modified_table ("value") values ('fixture teardown modification')$teardown$
