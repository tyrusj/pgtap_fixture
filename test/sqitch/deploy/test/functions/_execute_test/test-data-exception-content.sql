-- Deploy dream-db-extension-tests:test/functions/_execute_test/test-data-exception-content to pg

BEGIN;

create function unit_test.test_func_execute_test__test_data_exception_content()
returns setof text
language plpgsql
as
$$
...
with the test, then for each test datum, if the test throws an exception, then the function shall
return twice indented commented exception content.
$test_description$;
