-- Verify dream-db-extension-tests:functions/add_test/non-null-schema-and-function on pg
...
declare _expected_function_name name := 'test_func_add_test__non_null_schema_and_function';
