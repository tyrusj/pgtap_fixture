-- Verify dream-db-extension-tests:test/functions/execute_tests/fixture-results on pg
...
declare _expected_function_name name := 'test_func_execute_tests__fixture_results';
