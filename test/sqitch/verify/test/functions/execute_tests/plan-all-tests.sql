-- Verify dream-db-extension-tests:functions/execute_tests/plan-all-tests on pg
...
declare _expected_function_name name := 'test_func_execute_tests__plan_all_tests';
