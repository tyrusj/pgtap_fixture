-- Verify dream-db-extension-tests:test/functions/execute_tests/missing-fixture-bail-out on pg
...
declare _expected_function_name name := 'test_func_execute_tests__missing_fixture_bail_out';
