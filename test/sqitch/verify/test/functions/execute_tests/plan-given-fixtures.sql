-- Verify dream-db-extension-tests:functions/execute_tests/plan-given-fixtures on pg
...
declare _expected_function_name name := 'test_func_execute_tests__plan_given_fixtures';
