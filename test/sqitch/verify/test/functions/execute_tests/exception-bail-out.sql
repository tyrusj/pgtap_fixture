-- Verify dream-db-extension-tests:test/functions/execute_tests/exception-bail-out on pg
...
declare _expected_function_name name := 'test_func_execute_tests__exception_bail_out';
