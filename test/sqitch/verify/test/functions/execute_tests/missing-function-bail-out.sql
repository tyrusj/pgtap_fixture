-- Verify dream-db-extension-tests:test/functions/execute_tests/missing-function-bail-out on pg
...
declare _expected_function_name name := 'test_func_execute_tests__missing_function_bail_out';
declare _expected_function_signatures text[] := array[''];
