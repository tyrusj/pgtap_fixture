-- Verify dream-db-extension-tests:func-plan-parent-fixtures-include-parent-fixture on pg
...
declare _expected_function_name name := 'test_func_plan_parent_fixtures__include_parent_fixture';
