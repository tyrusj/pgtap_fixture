-- Verify dream-db-extension-tests:func-plan-parent-fixture-recursively-plan-parent-fixtures on pg
...
declare _expected_function_name name := 'test_func_plan_parent_fixtures__recursively_plan_fixtures';
