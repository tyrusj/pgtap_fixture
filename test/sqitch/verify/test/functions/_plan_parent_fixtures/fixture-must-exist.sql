-- Verify dream-db-extension-tests:func-plan-parent-fixtures-fixture-must-exist on pg
...
declare _expected_function_name name := 'test_func_plan_parent_fixtures__fixture_must_exist';
