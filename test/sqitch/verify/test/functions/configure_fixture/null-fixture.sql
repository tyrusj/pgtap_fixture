-- Verify dream-db-extension-tests:functions/configure_fixture/null-fixture on pg
...
declare _expected_function_name name := 'test_func_config_fixture__null_fixture';
