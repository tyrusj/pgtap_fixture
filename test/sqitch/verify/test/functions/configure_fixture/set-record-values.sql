-- Verify dream-db-extension-tests:functions/configure_fixture/set-record-values on pg
...
declare _expected_function_name name := 'test_func_config_fixture__set_record_values';
