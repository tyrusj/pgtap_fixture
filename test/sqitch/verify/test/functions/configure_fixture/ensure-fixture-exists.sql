-- Verify dream-db-extension-tests:functions/configure_fixture/ensure-fixture-exists on pg
...
declare _expected_function_name name := 'test_func_config_fixture__ensure_fixture_exists';
