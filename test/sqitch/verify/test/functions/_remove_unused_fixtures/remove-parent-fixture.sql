-- Verify dream-db-extension-tests:functions/_remove_unused_fixtures/remove-parent-fixture on pg
...
declare _expected_function_name name := 'test_func_unused_fixtures__remove_parent_fixture';
