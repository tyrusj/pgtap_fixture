-- Verify dream-db-extension-tests:functions/_execute_test/setup-before-test on pg
...
declare _expected_function_name name := 'test_func_execute_test__setup_before_test';
