-- Verify dream-db-extension-tests:test/functions/_execute_test/no-arguments-plan on pg
...
declare _expected_function_name name := 'test_func_execute_test__no_arguments_plan';
