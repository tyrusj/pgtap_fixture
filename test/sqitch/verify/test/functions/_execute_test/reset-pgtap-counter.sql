-- Verify dream-db-extension-tests:test/functions/_execute_test/reset-pgtap-counter on pg
...
declare _expected_function_name name := 'test_func_execute_test__reset_pgtap_counter';
