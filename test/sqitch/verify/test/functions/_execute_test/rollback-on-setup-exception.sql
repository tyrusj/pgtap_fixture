-- Verify dream-db-extension-tests:functions/_execute_test/rollback-on-setup-exception on pg
...
declare _expected_function_name name := 'test_func_execute_test__rollback_on_setup_exception';
