-- Verify dream-db-extension-tests:functions/_execute_test/rollback-on-teardown-exception on pg
...
declare _expected_function_name name := 'test_func_execute_test__rollback_on_teardown_exception';
