-- Verify dream-db-extension-tests:functions/_execute_test/set-test-description on pg
...
declare _expected_function_name name := 'test_func_execute_test__set_test_description';
