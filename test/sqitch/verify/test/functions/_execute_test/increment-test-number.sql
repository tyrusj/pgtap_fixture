-- Verify dream-db-extension-tests:test/functions/_execute_test/increment-test-number on pg
...
declare _expected_function_name name := 'test_func_execute_test__increment_test_number';
