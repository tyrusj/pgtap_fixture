-- Verify dream-db-extension-tests:functions/_execute_test/return-results on pg
...
declare _expected_function_name name := 'test_func_execute_test__return_results';
