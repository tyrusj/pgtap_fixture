-- Verify dream-db-extension-tests:text/functions/_format_result/content-order on pg
...
declare _expected_function_name name := 'test_func_format_result__content_order';
