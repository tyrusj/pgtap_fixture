-- Verify dream-db-extension-tests:test/functions/_format_result/comment-lines on pg
...
declare _expected_function_name name := 'test_func_format_result__comment_lines';
