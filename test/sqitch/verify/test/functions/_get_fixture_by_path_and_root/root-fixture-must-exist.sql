-- Verify dream-db-extension-tests:functions/_get_fixture_by_path_and_root/root-fixture-must-exist on pg
...
declare _expected_function_name name := 'test_func_get_fixture__root_fixture_must_exist';
