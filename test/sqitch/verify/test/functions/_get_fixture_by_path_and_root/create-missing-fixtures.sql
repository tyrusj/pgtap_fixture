-- Verify dream-db-extension-tests:functions/_get_fixture_by_path_and_root/create-missing-fixtures on pg
...
declare _expected_function_name name := 'test_func_get_fixture__create_missing_fixtures';
