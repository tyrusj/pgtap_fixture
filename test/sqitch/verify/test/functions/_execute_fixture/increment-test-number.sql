-- Verify dream-db-extension-tests:test/functions/_execute_fixture/increment-test-number on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__increment_test_number';
