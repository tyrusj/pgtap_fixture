-- Verify dream-db-extension-tests:test/functions/_execute_fixture/return-status on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__return_status';
