-- Verify dream-db-extension-tests:test/functions/_execute_fixture/return-subtest on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__return_subtest';
