-- Verify dream-db-extension-tests:test/functions/_execute_fixture/skip-empty on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__skip_empty';
