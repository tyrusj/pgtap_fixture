-- Verify dream-db-extension-tests:functions/_execute_fixture/teardown-on-shutdown-exception on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__teardown_on_shutdown_exception';
