-- Verify dream-db-extension-tests:functions/_execute_fixture/setup-before on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__setup_before';
