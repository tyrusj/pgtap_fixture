-- Verify dream-db-extension-tests:functions/_execute_fixture/execute-fixtures on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__execute_fixtures';
