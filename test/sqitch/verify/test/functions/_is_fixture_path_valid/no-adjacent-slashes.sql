-- Verify dream-db-extension-tests:functions/_is_fixture_path_valid/no-adjacent-slashes on pg
...
declare _expected_function_name name := 'test_func_valid_path__no_adjacent_slashes';
