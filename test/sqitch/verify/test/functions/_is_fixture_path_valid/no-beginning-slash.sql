-- Verify dream-db-extension-tests:functions/_is_fixture_path_valid/no-beginning-slash on pg
...
declare _expected_function_name name := 'test_func_valid_path__no_beginning_slash';
