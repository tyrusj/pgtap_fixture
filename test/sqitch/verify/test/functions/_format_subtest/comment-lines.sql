-- Verify dream-db-extension-tests:test/functions/_format_subtest/comment-lines on pg
...
declare _expected_function_name name := 'test_func_format_subtest__comment_lines';
