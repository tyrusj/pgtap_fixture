-- Verify dream-db-extension-tests:test/functions/_format_subtest/escape-special-characters on pg
...
declare _expected_function_name name := 'test_func_format_subtest__escape_special_characters';
