-- Verify dream-db-extension-tests:functions/plan-child-tests-and-fixtures/recursively-plan-tests-and-fixtures on pg
...
declare _expected_function_name name := 'test_func_plan_children__recursively_plan';
