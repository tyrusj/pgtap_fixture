-- Verify dream-db-extension-tests:functions/remove_test/remove-unused-fixtures on pg
...
declare _expected_function_name name := 'test_func_remove_test__remove_unused_fixtures';
