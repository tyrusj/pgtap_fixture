-- Verify dream-db-extension-tests:table-test-update-unique-schema-and-function on pg
...
declare _expected_function_name name := 'test_table_test_update__unique_schema_and_function';
