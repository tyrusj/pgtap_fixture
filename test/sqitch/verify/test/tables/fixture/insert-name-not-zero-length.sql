-- Verify dream-db-extension-tests:table-fixture-insert-name-not-zero-length on pg
...
declare _expected_function_name name := 'test_table_fixture_insert__name_not_zero_length';
