-- Verify dream-db-extension-tests:table-fixture-update-unique-name-and-parent on pg
...
declare _expected_function_name name := 'test_table_fixture_update__unique_name_and_parent';
