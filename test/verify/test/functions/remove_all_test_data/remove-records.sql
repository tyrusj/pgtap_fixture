-- Verify dream-db-extension-tests:functions/remove_all_test_data/remove-records on pg
...
declare _expected_function_name name := 'test_func_remove_all_data__remove_records';
