-- Verify dream-db-extension-tests:functions/plan-tests-and-fixtures/tests-must-exist on pg
...
declare _expected_function_name name := 'test_func_plan__tests_must_exist';
