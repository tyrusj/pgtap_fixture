-- Verify dream-db-extension-tests:functions/plan-tests-and-fixtures/include-fixtures on pg
...
declare _expected_function_name name := 'test_func_plan__include_fixtures';
