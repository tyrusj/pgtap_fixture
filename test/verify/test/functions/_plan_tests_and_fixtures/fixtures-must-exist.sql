-- Verify dream-db-extension-tests:functions/plan-tests-and-fixtures/fixtures-must-exist on pg
...
declare _expected_function_name name := 'test_func_plan__fixtures_must_exist';
