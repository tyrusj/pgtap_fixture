-- Verify dream-db-extension-tests:test/functions/_format_skip/content-order on pg
...
declare _expected_function_name name := 'test_func_format_skip__content_order';
