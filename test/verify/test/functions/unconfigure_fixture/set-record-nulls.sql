-- Verify dream-db-extension-tests:functions/unconfigure_fixture/set-record-nulls on pg
...
declare _expected_function_name name := 'test_func_unconfig_fixture__set_record_nulls';
