-- Verify dream-db-extension-tests:functions/unconfigure_fixture/remove-unused-fixtures on pg
...
declare _expected_function_name name := 'test_func_unconfig_fixture__remove_unused_fixtures';
