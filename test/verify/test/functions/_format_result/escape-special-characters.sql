-- Verify dream-db-extension-tests:test/functions/_format_result/escape-special-characters on pg
...
declare _expected_function_name name := 'test_func_format_result__escape_special_characters';
