-- Verify dream-db-extension-tests:functions/remove_test_data/remove-record on pg
...
declare _expected_function_name name := 'test_func_remove_data__remove_record';
