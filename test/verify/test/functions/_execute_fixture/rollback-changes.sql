-- Verify dream-db-extension-tests:functions/_execute_fixture/rollback-changes on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__rollback_changes';
