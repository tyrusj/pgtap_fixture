-- Verify dream-db-extension-tests:test/functions/_execute_fixture/fixture-results on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__fixture_results';
