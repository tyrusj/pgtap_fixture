-- Verify dream-db-extension-tests:functions/_execute_fixture/shutdown-after on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__shutdown_after';
