-- Verify dream-db-extension-tests:test/functions/_execute_fixture/not-ok-on-exception on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__not_ok_on_exception';
