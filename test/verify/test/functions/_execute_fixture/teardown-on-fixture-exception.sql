-- Verify dream-db-extension-tests:functions/_execute_fixture/teardown-on-fixture-exception on pg
...
declare _expected_function_name name := 'test_func_execute_fixture__teardown_on_fixture_exception';
