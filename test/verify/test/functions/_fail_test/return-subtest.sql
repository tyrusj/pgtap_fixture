-- Verify dream-db-extension-tests:test/functions/_fail_test/return-subtest on pg
...
declare _expected_function_name name := 'test_func_fail_test__return_subtest';
