-- Verify dream-db-extension-tests:test/functions/_fail_test/exception-on-missing-id on pg
...
declare _expected_function_name name := 'test_func_fail_test__exception_on_missing_id';
