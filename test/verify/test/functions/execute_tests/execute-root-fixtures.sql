-- Verify dream-db-extension-tests:functions/execute_tests/execute-root-fixtures on pg
...
declare _expected_function_name name := 'test_func_execute_tests__execute_root_fixtures';
