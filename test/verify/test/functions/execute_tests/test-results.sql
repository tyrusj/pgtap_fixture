-- Verify dream-db-extension-tests:test/functions/execute_tests/test-results on pg
...
declare _expected_function_name name := 'test_func_execute_tests__test_results';
