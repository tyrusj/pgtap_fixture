-- Verify dream-db-extension-tests:test/functions/execute_tests/return-plan on pg
...
declare _expected_function_name name := 'test_func_execute_tests__return_plan';
