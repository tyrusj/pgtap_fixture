-- Verify dream-db-extension-tests:test/functions/execute_tests/increment-test-number on pg
...
declare _expected_function_name name := 'test_func_execute_tests__increment_test_number';
