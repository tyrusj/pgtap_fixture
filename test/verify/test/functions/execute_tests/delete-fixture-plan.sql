-- Verify dream-db-extension-tests:functions/execute_tests/delete-fixture-plan on pg
...
declare _expected_function_name name := 'test_func_execute_tests__delete_fixture_plan';
