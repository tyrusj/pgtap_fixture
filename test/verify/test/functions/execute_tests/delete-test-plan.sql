-- Verify dream-db-extension-tests:functions/execute_tests/delete-test-plan on pg
...
declare _expected_function_name name := 'test_func_execute_tests__delete_test_plan';
