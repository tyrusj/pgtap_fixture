-- Verify dream-db-extension-tests:test/functions/execute_tests/return-version on pg
...
declare _expected_function_name name := 'test_func_execute_tests__return_version';
