-- Verify dream-db-extension-tests:test/functions/_format_plan/comment-lines on pg
...
declare _expected_function_name name := 'test_func_format_plan__comment_lines';
