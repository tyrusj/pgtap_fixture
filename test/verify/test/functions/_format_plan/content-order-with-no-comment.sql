-- Verify dream-db-extension-tests:test/functions/_format_plan/content-order-with-no-comment on pg
...
declare _expected_function_name name := 'test_func_format_plan__content_order_with_no_comment';
