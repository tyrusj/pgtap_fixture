-- Verify dream-db-extension-tests:functions/add_test/ensure-fixture-exists on pg
...
declare _expected_function_name name := 'test_func_add_test__ensure_fixture_exists';
