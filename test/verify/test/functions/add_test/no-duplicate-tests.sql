-- Verify dream-db-extension-tests:functions/add_test/no-duplicate-tests on pg
...
declare _expected_function_name name := 'test_func_add_test__no_duplicate_tests';
