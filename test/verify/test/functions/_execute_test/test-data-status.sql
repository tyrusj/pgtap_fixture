-- Verify dream-db-extension-tests:test/functions/_execute_test/test-data-status on pg
...
declare _expected_function_name name := 'test_func_execute_test__test_data_status';
