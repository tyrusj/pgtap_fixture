-- Verify dream-db-extension-tests:test/functions/_execute_text/multiple-functions on pg
...
declare _expected_function_name name := 'test_func_execute_test__multiple_functions';
