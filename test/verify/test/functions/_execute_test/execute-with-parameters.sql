-- Verify dream-db-extension-tests:functions/_execute_test/execute-with-parameters on pg
...
declare _expected_function_name name := 'test_func_execute_test__execute_with_parameters';
