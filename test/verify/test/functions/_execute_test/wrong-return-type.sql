-- Verify dream-db-extension-tests:test/functions/_execute_test/wrong-return-type on pg
...
declare _expected_function_name name := 'test_func_execute_test__wrong_return_type';
