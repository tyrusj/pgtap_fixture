-- Verify dream-db-extension-tests:test/functions/_execute_test/function-does-not-exist on pg
...
declare _expected_function_name name := 'test_func_execute_test__function_does_not_exist';
