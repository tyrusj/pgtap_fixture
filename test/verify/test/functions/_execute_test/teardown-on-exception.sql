-- Verify dream-db-extension-tests:functions/_execute_test/teardown-on-exception on pg
...
declare _expected_function_name name := 'test_func_execute_test__teardown_on_exception';
