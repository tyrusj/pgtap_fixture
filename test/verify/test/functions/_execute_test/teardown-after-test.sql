-- Verify dream-db-extension-tests:functions/_execute_test/teardown-after-test on pg
...
declare _expected_function_name name := 'test_func_execute_test__teardown_after_test';
