-- Verify dream-db-extension-tests:test/functions/_execute_test/wrong-input-types on pg
...
declare _expected_function_name name := 'test_func_execute_test__wrong_input_types';
