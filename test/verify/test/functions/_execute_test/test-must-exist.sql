-- Verify dream-db-extension-tests:functions/_execute_test/test-must-exist on pg
...
declare _expected_function_name name := 'test_func_execute_test__test_must_exist';
