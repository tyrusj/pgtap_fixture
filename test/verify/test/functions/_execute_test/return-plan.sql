-- Verify dream-db-extension-tests:test/functions/_execute_test/return-plan on pg
...
declare _expected_function_name name := 'test_func_execute_test__return_plan';
