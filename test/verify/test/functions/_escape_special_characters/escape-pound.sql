-- Verify dream-db-extension-tests:test/functions/_escape_special_characters/escape-pound on pg
...
declare _expected_function_name name := 'test_func_escape__escape_pound';
