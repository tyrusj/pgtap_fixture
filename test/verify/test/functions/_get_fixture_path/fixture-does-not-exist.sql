-- Verify dream-db-extension-tests:test/functions/_get_fixture_path/fixture-does-not-exist on pg
...
declare _expected_function_name name := 'test_func_get_path__fixture_does_not_exist';
