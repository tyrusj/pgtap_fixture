-- Verify dream-db-extension-tests:test/functions/_get_fixture_path/return-path on pg
...
declare _expected_function_name name := 'test_func_get_path__return_path';
