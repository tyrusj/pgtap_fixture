-- Verify dream-db-extension-tests:functions/plan-child-tests-and-fixtures/plan-tests on pg
...
declare _expected_function_name name := 'test_func_plan_children__plan_tests';
