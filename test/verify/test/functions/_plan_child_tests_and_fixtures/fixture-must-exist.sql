-- Verify dream-db-extension-tests:functions/plan-child-tests-and-fixtures/fixture-must-exist on pg
...
declare _expected_function_name name := 'test_func_plan_children__fixture_must_exist';
