-- Verify dream-db-extension-tests:table-test-data-insert-unique-test-id-role-and-parameters on pg
...
declare _expected_function_name name := 'test_table_test_data_insert__unique_test_id_role_and_parameters';
