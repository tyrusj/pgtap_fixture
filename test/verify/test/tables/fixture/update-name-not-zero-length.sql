-- Verify dream-db-extension-tests:table-fixture-update-name-not-zero-length on pg
...
declare _expected_function_name name := 'test_table_fixture_update__name_not_zero_length';
