-- Deploy dream-db-extension-tests:functions/_execute_fixture/teardown-on-fixture-exception to pg

BEGIN;

create function unit_test.test_func_execute_fixture__teardown_on_fixture_exception()
returns setof text
language plpgsql
as
$$
