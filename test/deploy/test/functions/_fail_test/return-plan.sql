-- Deploy dream-db-extension-tests:test/functions/_fail_test/return-plan to pg

BEGIN;

create function unit_test.test_func_fail_test__return_plan()
returns setof text
language plpgsql
as
$$
declare test_description text := $test_description$
When failing a test, the function shall return an indented formatted plan with size 0.
$test_description$;
